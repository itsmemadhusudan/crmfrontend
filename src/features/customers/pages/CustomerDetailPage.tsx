...
export default function CustomerDetailPage() {
  ...
  useEffect(() => {
    if (!id) return;
    Promise.all([
      getCustomer(id).then((r) => r.success && r.customer && setCustomer((r as { customer: Customer & { primaryBranchId?: string | null } }).customer)),
  ...
  async function handleEditSubmit(e: React.FormEvent) {
    ...
    if (r.success && r.customer) {
      setCustomer({ ...customer, ...(r as { customer: Customer }).customer });
