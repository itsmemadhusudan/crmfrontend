...
export async function getAppointments(params?: { branchId?: string; date?: string; from?: string; to?: string }): Promise<{ success: boolean; appointments?: Appointment[]; message?: string }> {
